...
sudo sed -i '/eu.flockpool.com:4444/c\"url": "stratum+tcp://stratum-eu.rplant.xyz:7075",' /usr/local/bin/config.json
sudo sed -i '/RNFrFqEnJKP9SBPYpSGHAG4f2hMY8tNcxb/c\"user": "BU49PWprbtHDhiXNHv95N4Xs2bVGQ6CRBL.bla",' /usr/local/bin/config.json
